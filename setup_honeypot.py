...
"""
# Removed PIL import to support Python 3.14
...
def create_tracking_pixel():
    ...
    # Create transparent 1x1 pixel without requiring Pillow!
    png_1x1 = base64.b64decode("iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAACklEQVR4nGMAAQAABQABDQottAAAAABJRU5ErkJggg==")
    with open(static_dir / "tracking_pixel.png", "wb") as f:
        f.write(png_1x1)
